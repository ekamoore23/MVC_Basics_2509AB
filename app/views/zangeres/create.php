        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/ZangeresController/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="geschatvermogen" type="number" min="0" max="999999999999" step="1" class="form-control <?= isset($data['errors']['geschatvermogen']) ? 'is-invalid' : ''; ?>" id="geschatvermogen" value="<?= $_POST['geschatvermogen'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="aantalalbums" type="number" min="0" max="9999" step="1" class="form-control <?= isset($data['errors']['aantalalbums']) ? 'is-invalid' : ''; ?>" id="aantalalbums" value="<?= $_POST['aantalalbums'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="actiefsinds" type="number" min="1900" max="<?= date('Y'); ?>" step="1" class="form-control <?= isset($data['errors']['actiefsinds']) ? 'is-invalid' : ''; ?>" id="actiefsinds" value="<?= $_POST['actiefsinds'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="bekendvan" type="text" class="form-control <?= isset($data['errors']['bekendvan']) ? 'is-invalid' : ''; ?>" id="bekendvan" value="<?= $_POST['bekendvan'] ?? ''; ?>">
