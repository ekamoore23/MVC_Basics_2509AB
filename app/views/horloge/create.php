        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/HorlogeController/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="prijs" type="number" min="0" max="99999" step="0.01" class="form-control <?= isset($data['errors']['prijs']) ? 'is-invalid' : ''; ?>" id="prijs" value="<?= $_POST['prijs'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="gewicht" type="number" min="0" max="1000" step="1.00" class="form-control <?= isset($data['errors']['gewicht']) ? 'is-invalid' : ''; ?>" id="gewicht" value="<?= $_POST['gewicht'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="waterdichtheid" type="text" class="form-control <?= isset($data['errors']['waterdichtheid']) ? 'is-invalid' : ''; ?>" id="waterdichtheid" value="<?= $_POST['waterdichtheid'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="uniekkenmerk" type="text" class="form-control <?= isset($data['errors']['uniekkenmerk']) ? 'is-invalid' : ''; ?>" id="uniekkenmerk" value="<?= $_POST['uniekkenmerk'] ?? ''; ?>">
